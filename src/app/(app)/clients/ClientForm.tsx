                ...
                {checkedServices.has(service) && (
                  <div className="flex items-center gap-1">
                    <input
                      ...
                      className="w-24 rounded-md border border-zinc-300 dark:border-zinc-700 bg-white dark:bg-zinc-900 px-2 py-1 text-sm outline-none focus:ring-2 focus:ring-brand"
                    />
